                ...
                <div class="card-box">
                  <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th style="color: red;"><?php echo htmlspecialchars( $value1["NOME"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                        <th style="color: red;"><?php echo htmlspecialchars( $value1["CPF"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                        <th style="color: red;"><?php echo htmlspecialchars( $value1["CARGO"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                        <th style="color: red;"><?php echo htmlspecialchars( $value1["CENTRO_CUSTO"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                        <th style="color: red;"><?php echo htmlspecialchars( $value1["DESCRICAO_CC"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                        <th style="color: red;"><?php echo htmlspecialchars( $value1["FILIAL"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                        <th style="color: red;"><?php echo htmlspecialchars( $value1["EMPRESA"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                        <th style="color: red;"><?php echo htmlspecialchars( $value1["DT_DEMISSAO_CONVERTIDA"], ENT_COMPAT, 'UTF-8', FALSE ); ?></th>
                        <th></th>
                      </tr>
                      <?php } ?>
...
<div class="modal fade bs-example-modal-lg" id="listacc" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content p-2">
      ...
      <table id="lista_cc" class="table table-striped table-sm table-bordered dt-responsive nowrap" cellspacing="0"
        width="100%">
        <thead>
          <tr>
